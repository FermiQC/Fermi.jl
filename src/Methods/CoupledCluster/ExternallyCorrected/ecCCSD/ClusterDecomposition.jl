...
function get_casT2!(T1::Array{Float64,2}, T2::Array{Float64,4}, Ccas::Array{Float64,1}, dets::Vector{Determinant{T}}, ref::Determinant{T}, frozen::Int, ndocc::Int) where T <: Integer
