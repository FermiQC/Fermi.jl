...
function find_T3(ridx::NTuple{6,Int}, C3coef::Array{Float64,1}, C3dets::Array{Determinant,1}, ref::Determinant, frozen::Int, ndocc::Int, T1::Array{Float64,2}, T2::Array{Float64,4})
...
function get_casT4αβ(idx::NTuple{8,Int}, Coef::Float64, C3coef::Array{Float64,1}, C3dets::Array{Determinant,1}, 
    ...
    T3(ridx) = find_T3(ridx, C3coef, C3dets, ref, frozen, ndocc, T1, T2)
...
function ec_T4αβonT2!(ridx::NTuple{8,Int}, T4::Float64, ecT2::Array{Float64,4}, Voovv::Array{Float64,4})
    ...
    ecT2[i,j,a,b] += 0.25*T4*Voovv[l,k,d,c]
    ecT2[i,j,a,b] += 0.25*T4*Voovv[k,l,c,d]
    ecT2[i,j,a,b] += 0.25*T4*Voovv[k,l,c,d]
    ecT2[i,j,a,b] += 0.25*T4*Voovv[l,k,d,c]
...
function ec_T4ααonT2!(ridx::NTuple{8,Int}, T4::Float64, ecT2::Array{Float64,4}, Voovv::Array{Float64,4})
    ...
    ecT2[i,j,a,b] +=  0.25*T4*Voovv[k,l,c,d]
    ecT2[i,j,a,b] += -0.25*T4*Voovv[l,k,c,d]
    ecT2[j,i,b,a] += -0.25*T4*Voovv[l,k,c,d]
    ecT2[j,i,b,a] +=  0.25*T4*Voovv[k,l,c,d]
